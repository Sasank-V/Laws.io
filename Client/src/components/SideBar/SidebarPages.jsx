    ...
    return (
        !isHamburg ?
            <div className="flex flex-col gap-3">
                <Link to="/" className={`size-[35px] flex items-center gap-2 cursor-pointer w-full`} onClick={() => setPageNumber(0)}>
                ...
                <Link to="/LOTD" className={`size-[35px] flex items-center gap-2 cursor-pointer w-full`} onClick={() => setPageNumber(1)}>
                ...
                <Link to="/Quiz" className={`size-[35px] flex items-center gap-2 cursor-pointer w-full`} onClick={() => setPageNumber(2)}>
                ...
                <Link to="/" className={`size-[35px] flex items-center gap-2 cursor-pointer mb-5 w-full`} onClick={() => setPageNumber(4)}>
            ...
            <div className="flex flex-col gap-3">
                ...
                <Link to="/" className="size-[35px] flex items-center gap-2 cursor-pointer w-full mb-4" onClick={() => setPageNumber(4)}>
                    <img src={GameController} alt="" className={`${pageNumber == 4 ? "invert bg-black rounded-lg" : "invert-0"} size-[35px]`} />
