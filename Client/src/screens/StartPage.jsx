...
const StartPage = () => {
    return (
        <div className='flex flex-col w-full h-full justify-center items-center text-white'>
            ...
            <div className='bg-[#06870B] cursor-pointer transition-all duration-250 ease-in-out hover:p-5 hover:px-8 md:hover:p-6 md:hover:px-12 p-3 px-6 md:p-5 md:px-10 text-xl font-semibold rounded-2xl absolute top-[75%]'>
                START PLAYING
            </div>
        </div>
    )
