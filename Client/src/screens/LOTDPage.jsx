...
const LOTD = ({ setPageNumber }) => {
    ...
    return (
        <>
            <div className=" parent text-white rounded-[50px] w-11/12 h-11/12 text-center flex flex-col bg-[#003366] ">
                ...
                <div className=" child w-[90%] absolute items-center px-6 justify-between bottom-4 flex">
